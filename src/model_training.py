...
# Ensure the logs directly exists
log_dir = "logs"
...
def train_model(X_train: np.ndarray, y_train: np.ndarray, params: dict) -> RandomForestClassifier:
    ...
    :param params: Directory of hyperparameters
...
def main():
    try:
        ...
        model_save_path = "models/model.pkl"        # creating a filder name "models" inside that "model.pkl" file save
        save_model(clf, model_save_path)

    except Exception as e:
        logger.error("Failed to complete the model biulding process : %s", e)
        print(f"Error : {e}")
